...
export default function CreateCase() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.title || !formData.category || !formData.description || !formData.assignedLawyer) {
            setError("PROTOCOL_ERROR: missing required fields. Please assign a lawyer.");
            setLoading(false);
            return;
        }
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            ...
                            <div>
                                <label htmlFor="assignedLawyer" className="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-widest" style={{ fontFamily: "'Share Tech Mono', monospace" }}>
                                    Assign Legal Counsel <span className="text-teal-400">*</span>
                                </label>
                                <div className="relative">
                                    <select
                                        id="assignedLawyer"
                                        ...
                                        required
                                    >
                                        <option className="bg-[#0b1220] text-slate-500" value="" disabled>-- Select Lawyer --</option>
                                        {lawyers.map(lawyer => (
