  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-[#0f172a] via-[#0b1220] to-[#0a0f1c] text-white">
      ...
      <main className="flex-1 p-8 md:p-12">
        ...
        {/* Create Button */}
        <div className="mb-10">
          <button className="px-7 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 font-semibold shadow-lg shadow-blue-500/20 hover:scale-105 hover:shadow-blue-500/40 transition-all duration-300">
            + Create New Case
          </button>
        </div>
